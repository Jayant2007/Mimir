...
>
> ÔÇö Norse mythology (Prose Edda, Snorri Sturluson c. 1220)
...
grow ÔÇö not as a flat key-value store, but as a living, decaying, emotionally
...
orchestrates the **Vivid ecosystem** ÔÇö [VividnessMem](https://pypi.org/project/vividnessmem/)
for neurochemistry and [VividEmbed](https://pypi.org/project/vividembed/) for
semantic retrieval ÔÇö then layers **twenty-one neuroscience mechanisms** on top.
...
**involuntarily recalled** by stray associations ÔÇö the same way human memory
actually works.
...
Ôöé                   M├¡mir                         Ôöé
Ôöé                                                 Ôöé
Ôöé  ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ  ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ  ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ  Ôöé
Ôöé  Ôöé Episodic  Ôöé  Ôöé Procedural Ôöé  Ôöé  Social   Ôöé  Ôöé
Ôöé  Ôöé Memories  Ôöé  Ôöé  Lessons   Ôöé  ÔöéImpressionsÔöé  Ôöé
Ôöé  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔö¼ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔö¼ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔö¼ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ  Ôöé
Ôöé        Ôöé              Ôöé              Ôöé          Ôöé
Ôöé  ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ   Ôöé
Ôöé  Ôöé         21 Neuroscience Layers          Ôöé   Ôöé
Ôöé  Ôöé  flashbulb ┬À reconsolidation ┬À state-   Ôöé   Ôöé
Ôöé  Ôöé  dependent ┬À spreading activation ┬À     Ôöé   Ôöé
Ôöé  Ôöé  RIF ┬À Zeigarnik ┬À involuntary recall ┬À Ôöé   Ôöé
Ôöé  Ôöé  temporal gist ┬À episodic time ┬À        Ôöé   Ôöé
Ôöé  Ôöé  visual imagery                         Ôöé   Ôöé
Ôöé  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö¼ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ   Ôöé
Ôöé                    Ôöé                            Ôöé
Ôöé  ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ   Ôöé
Ôöé  Ôöé        Hybrid Retrieval Bridge          Ôöé   Ôöé
Ôöé  Ôöé   BM25 keywords + VividEmbed semantic   Ôöé   Ôöé
Ôöé  Ôöé   + Date index ÔåÆ 5-signal re-rank       Ôöé   Ôöé
Ôöé  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö¼ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ   Ôöé
Ôöé                    Ôöé                            Ôöé
Ôöé  ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ  ÔöîÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ              Ôöé
Ôöé  ÔöéVividnessMemÔöé  Ôöé  VividEmbed  Ôöé              Ôöé
Ôöé  Ôöé chemistry  Ôöé  Ôöé  384-d + PAD Ôöé              Ôöé
Ôöé  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ  ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ              Ôöé
...
M├¡mir is the orchestration layer. The engines underneath are independently
published and pip-installable:

| Package | Role | PyPI |
|---------|------|------|
| **VividnessMem** | Neurochemistry engine ÔÇö 5 neurotransmitters (dopamine, serotonin, cortisol, oxytocin, norepinephrine), 10 event profiles, 9 cognitive modifiers, emotional firewall, dampening, audit logging | `pip install vividnessmem` |
| **VividEmbed** | Semantic embedding engine ÔÇö fine-tuned MiniLM producing 389-d hybrid vectors (384-d sentence + 3-d PAD emotion + 2-d meta), emotion-space queries, contradiction detection | `pip install vividembed` |
| **M├¡mir** | Orchestrator ÔÇö 21 neuroscience mechanisms, hybrid BM25+semantic retrieval, temporal awareness, visual memory, task branch, encryption at rest, LLM integration, visualization, context-block generation for LLM prompt injection | *(this repo)* |

All three are **optional for each other**. M├¡mir works standalone (with
graceful fallbacks), but every engine amplifies the others:

- Without VividnessMem ÔåÆ neurochemistry modifiers default to 1.0, no
  emotional audit log
- Without VividEmbed ÔåÆ recall falls back to BM25 keyword search only
- Without Pillow ÔåÆ visual memory falls back to text descriptions
- Without `cryptography` ÔåÆ encryption at rest is disabled, data stored as plaintext JSON
...
| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| Organic spaced-repetition decay | Yes | ÔÇö | Yes |
| 60-emotion PAD vector space | Yes | Yes | Yes |
| Memory vividness (0ÔåÆ1 lifecycle) | Yes | ÔÇö | Yes |
| Importance scoring (1-10) | Yes | Yes | Yes |
| Content-addressable deduplication | Yes | ÔÇö | Yes |
| `__slots__`-optimised Memory class | Yes | ÔÇö | Yes (27 slots) |
...
| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| 5 neurotransmitters (DA, 5-HT, CORT, OXT, NE) | Yes (engine) | ÔÇö | Yes (via VMem) |
| 10 life-event profiles | Yes | ÔÇö | Yes |
| 9 cognitive modifiers | Yes | ÔÇö | Yes |
| Emotional firewall (safety limits) | Yes | ÔÇö | Yes |
| Emotional dampening (self-regulation) | Yes | ÔÇö | Yes |
| Emotional audit log | Yes | ÔÇö | Yes |
| Cognitive override (reappraisal) | Yes | ÔÇö | Yes |
| Mood EMA blending | Yes | ÔÇö | Yes |
| Emotion drift detection + reframe | ÔÇö | ÔÇö | Yes |

### Retrieval

| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| BM25 keyword search | ÔÇö | ÔÇö | Yes |
| Semantic vector search (389-d) | ÔÇö | Yes | Yes (via VEmbed) |
| Hybrid BM25 + semantic fusion | ÔÇö | ÔÇö | Yes |
| 5-signal re-ranking | ÔÇö | ÔÇö | Yes |
| Spreading activation (priming) | ÔÇö | ÔÇö | Yes |
| Retrieval-induced forgetting | ÔÇö | ÔÇö | Yes |
| Involuntary recall (unbidden) | ÔÇö | ÔÇö | Yes |
| State-dependent retrieval (mood) | ÔÇö | ÔÇö | Yes |
| Emotion-space queries | ÔÇö | Yes | Yes |
| Contradiction detection | ÔÇö | Yes | Yes |

### Neuroscience Mechanisms

| Mechanism | VividnessMem | VividEmbed | M├¡mir |
|-----------|:---:|:---:|:---:|
| Flashbulb memory (Brown & Kulik 1977) | ÔÇö | ÔÇö | Yes |
| Reconsolidation (Nader 2000) | ÔÇö | ÔÇö | Yes |
| State-dependent retrieval (Godden & Baddeley 1975) | ÔÇö | ÔÇö | Yes |
| Spreading activation (Collins & Loftus 1975) | ÔÇö | ÔÇö | Yes |
| Retrieval-induced forgetting (Anderson 1994) | ÔÇö | ÔÇö | Yes |
| Zeigarnik effect (Zeigarnik 1927) | ÔÇö | ÔÇö | Yes |
| Involuntary memory (Berntsen 2009) | ÔÇö | ÔÇö | Yes |
| Temporal gist extraction (Tulving 1972) | ÔÇö | ÔÇö | Yes |
| Temporal/episodic dating | ÔÇö | ÔÇö | Yes |
| Visual/mental imagery (Kosslyn 1980) | ÔÇö | ÔÇö | Yes |
| Huginn ÔÇö background insight generation | ÔÇö | ÔÇö | Yes |
| Muninn ÔÇö consolidation daemon | ÔÇö | ÔÇö | Yes |
| Yggdrasil ÔÇö memory graph | ÔÇö | ÔÇö | Yes |
| V├Âlva's Vision ÔÇö dream synthesis | ÔÇö | ÔÇö | Yes |
| Hippocampal pattern separation (Yassa & Stark 2011) | ÔÇö | Yes | Yes |
| Narrative arc tracking (Freytag 1863) | ÔÇö | Yes | Yes |
| Enhanced relational reasoning (LLM-inferred) | ÔÇö | ÔÇö | Yes |
| Hierarchical memory organisation | ÔÇö | ÔÇö | Yes |
| Mental time travel (Tulving 1985) | ÔÇö | ÔÇö | Yes |
| Novelty-modulated encoding (Ranganath & Rainer 2003) | ÔÇö | ÔÇö | Yes |
| Enhanced drift analysis (velocity + bias) | ÔÇö | ÔÇö | Yes |

### Embedding & Vectors

| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| Fine-tuned MiniLM (384-d) | ÔÇö | Yes | Yes (via VEmbed) |
| 3-d PAD emotion dimensions | ÔÇö | Yes | Yes |
| 2-d meta dimensions (importance + stability) | ÔÇö | Yes | Yes |
| Emotion-prefix tokenisation | ÔÇö | Yes | Yes |
| Batch encoding | ÔÇö | Yes | Yes |
| VividCortex LLM layer | ÔÇö | Yes | ÔÇö |
| Hippocampal pattern separation | ÔÇö | Yes | Yes |
| Narrative arc tracking | ÔÇö | Yes | Yes |

### Task / Project Management

| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| Project context switching | Yes | ÔÇö | Yes |
| Task lifecycle (active ÔåÆ done/failed) | Yes | ÔÇö | Yes |
| Action logging per task | Yes | ÔÇö | Yes |
| Solution pattern library | Yes | ÔÇö | Yes |
| Artifact tracking | Yes | ÔÇö | Yes |
| Project overview dashboard | Yes | ÔÇö | Yes |

### LLM Integration

| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| Query decomposition (vague ÔåÆ focused) | ÔÇö | Yes (Cortex) | Yes |
| Agentic memory ops (PROMOTE/DEMOTE/FORGET/UPDATE) | ÔÇö | Yes (Cortex) | Yes |
| LLM-driven reflection & self-analysis | ÔÇö | Yes (Cortex) | Yes |
| Context block generation for prompt injection | ÔÇö | ÔÇö | Yes |

### Visualization

| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| Memory timeline | ÔÇö | Yes (VividViz) | Yes |
| Emotion distribution | ÔÇö | Yes (VividViz) | Yes |
| Importance histogram | ÔÇö | Yes (VividViz) | Yes |
| Narrative arc distribution | ÔÇö | Yes (VividViz) | Yes |
| Drift report | ÔÇö | ÔÇö | Yes |
| Neurochemistry snapshot | ÔÇö | ÔÇö | Yes |
| Yggdrasil graph export | ÔÇö | ÔÇö | Yes |
| All-in-one viz payload (`viz_summary()`) | ÔÇö | ÔÇö | Yes |

### Security & Persistence

| Feature | VividnessMem | VividEmbed | M├¡mir |
|---------|:---:|:---:|:---:|
| Encryption at rest (Fernet + PBKDF2) | Yes | ÔÇö | Yes |
| Atomic file writes (crash-safe) | Yes | Yes | Yes |
| Inverted word index | ÔÇö | ÔÇö | Yes |
| Date index for temporal queries | ÔÇö | ÔÇö | Yes |
| Visual memory storage (WebP) | ÔÇö | ÔÇö | Yes |
...
High-arousal, high-importance events (importance ÔëÑ 8, emotional arousal ÔëÑ 0.6)
are encoded with permanent stability and vividness floors. They resist all
forms of decay ÔÇö like how you remember exactly where you were on a major life
event.
...
ÔÇö unless it's a flashbulb memory, which resists emotional drift.
...
Related concepts get an activation bonus on subsequent queries ÔÇö simulating the
way thinking about "astronomy" primes "telescope" and "stars". Activation
decays by 0.8├ù each tick.

### 5. Retrieval-Induced Forgetting *(Anderson 1994)*

Retrieving one memory **actively suppresses** competing memories that share
ÔëÑ 70% word overlap. Their stability is reduced by 0.15 ÔÇö the brain's way
of sharpening recall by inhibiting similar alternatives.

### 6. Zeigarnik Effect *(Zeigarnik 1927)*

Unresolved failures in procedural lessons are **1.5├ù more vivid** than
resolved ones. Incomplete tasks nag at the mind ÔÇö ensuring the agent keeps
...
memory surfaces unprompted ÔÇö a Proustian flash. This keeps old memories alive
...
an emotion tag. Detail fades but the emotional core survives ÔÇö unless the
...
- **Prospective memory**: Future dates with importance ÔëÑ 4 auto-create
  reminders ÔÇö the agent remembers upcoming events without being told to
...
|------|-----------|----------------------|
| **Vivid** | ÔëÑ 0.7 | Full-resolution WebP ÔÇö the agent can display it |
| **Faded** | 0.3ÔÇô0.7 | Degraded WebP (quality 30) ÔÇö a blurry mental image |
| **Gist only** | < 0.3 | Text description only ÔÇö "I remember a sunset but can't picture it" |
...
### 11. Huginn ÔÇö Thought *(Pattern Detection)*
...
- **Open threads**: Detects unresolved intentions ("I shouldÔÇª", "I need toÔÇª")
...
### 12. Muninn ÔÇö Memory *(Consolidation Daemon)*

Odin's raven of Memory performs sleep-time consolidation:

- **Merge near-duplicates**: Memories with Jaccard word overlap ÔëÑ 0.40 are
  merged ÔÇö the richer version is kept, importance and stability are preserved
...
- **Strengthen co-activated pairs**: Memories created on the same day get a
  stability boost (├ù1.05) ÔÇö the brain's way of reinforcing contextual links

### 13. Yggdrasil ÔÇö The World Tree *(Memory Graph)*
...
| **Lexical** | Word overlap 0.20ÔÇô0.55 | Jaccard ratio |
| **Temporal** | Within 3-day window | 1 ÔêÆ (days/3) |
| **Emotional** | Same emotion label | 0.5 |
| **Task-origin** | Co-members of the same task | 0.75 |
| **Caused-lesson** | Memory Ôåö lesson it spawned | 0.65 |
...
- `yggdrasil_roots()` ÔÇö anchor, flashbulb, and importance ÔëÑ 9 memories
- `yggdrasil_branches(memory)` ÔÇö directly connected memories
- `yggdrasil_traverse(memory, depth=2)` ÔÇö BFS within N hops
- `yggdrasil_path(a, b)` ÔÇö shortest path between two memories

During `recall()`, retrieved memories connected to other retrieved memories
via Yggdrasil get a +0.03 bonus each ÔÇö contextual association boosts recall.

### 14. V├Âlva's Vision *(Dream Synthesis)*

During sleep, the V├Âlva (Norse seeress) samples random memory pairs and
discovers hidden connections:

- **Emotional arcs**: Same keywords with different emotions ÔåÆ "My feelings
  about X shifted from Y to Z"
- **Theme bridges**: Memories 30+ days apart sharing words ÔåÆ long-range
  pattern recognition
- **Temporal clusters**: 3+ memories on the same day ÔåÆ "A lot happened on
  that day"
...
When two memories overlap ÔëÑ 80% lexically but are **not identical**, the system
...
Every memory is automatically classified into a narrative position ÔÇö **setup**,
**rising**, **climax**, **falling**, **resolution**, or **denouement** ÔÇö using
...
would miss ÔÇö for example connecting "bought hiking boots" to "planning a
...
- **Lesson ÔåÆ Memory**: Every lesson tracks the `source_memory_idx` of the
  episodic memory that caused it. Yggdrasil creates `caused_lesson` edges
  between them.
- **Task ÔåÆ Memory**: `start_task()`, `complete_task()`, and `fail_task()` all
...
- **Cross-hierarchy reinforcement**: When a lesson succeeds via
  `record_outcome()`, its origin memory receives a 15% stability boost ÔÇö
...
1. **Touch** ÔÇö the memory's access count and vividness are updated
2. **Mood restoration** ÔÇö the agent's mood is blended 60% toward the encoding
   mood, recreating the emotional state at the time of the original experience
3. **Neurochemistry trigger** ÔÇö matching neurochemical events are fired
   (excitement ÔåÆ `achievement`, fear ÔåÆ `threat`, etc.)
4. **Spreading activation** ÔÇö Yggdrasil activates connected memories, priming
   contextual recall
5. **Experiential context** ÔÇö returns a rich dict: gist, emotion,
...
overlap. Highly novel memories (average similarity < 0.85) receive a **1.3├ù
importance boost** ÔÇö the brain pays more attention to genuinely new
information. Redundant memories (similarity > 0.40) receive a **0.85├ù
...
- **Drift velocity**: Tracks the last 5 touches of each memory to compute
  how fast its emotion is shifting ÔÇö distinguishing "slowly warming" from
  "rapidly destabilising"
- **Cognitive bias detection**: When 75%+ of an entity's memories share the
  same emotional valence, a bias alert is surfaced ÔÇö helping the agent
...
The retrieval system solves the classic RAG problem ÔÇö keyword search misses
meaning while semantic search misses names and dates ÔÇö by fusing both:

### Stage 1: Broad Candidate Pool

Three channels work in parallel:

- **BM25 keyword search** ÔÇö IDF-weighted term matching via an inverted word
  index. Excels at proper nouns, dates, exact phrases.
- **VividEmbed semantic search** ÔÇö 384-d MiniLM + PAD cosine similarity.
  Excels at themes, paraphrases, emotional resonance.
- **Date index injection** ÔÇö Any dates mentioned in the query are matched
...
| Bonus | Value | Trigger |
|-------|-------|---------|
| Cherished memory | ├ù1.10 | `memory._cherished` flag |
...
Vividness is not a toggle ÔÇö it's a continuous curve:
...
diminishing returns (├ù0.85 per retrieval). This models the well-known spacing
effect from cognitive psychology.

**Floor protections:**
- Flashbulb memories: stability ÔëÑ 120, vividness ÔëÑ 0.85
- Anchor memories: stability ÔëÑ 90, vividness ÔëÑ 0.30
...
activation, cognitive override, visual memory storage, and life event ÔÇö making
...
```bash
# Core (zero required dependencies ÔÇö everything degrades gracefully)
...
pip install vividmimir[embedding]       # VividEmbed
...
=== THINGS ON MY MIND ===
ÔÇö I love deep philosophical conversations (curious)

=== MY IMPRESSIONS OF ALEX ===
ÔÇö Alex is always supportive (warm)

=== THINGS I'M LEARNING ===
ÔÇö Python debugging: Use pdb [OK]

=== SOMETHING THIS REMINDS ME OF ===
ÔÇö That time we talked about consciousness (fascinated)

=== IMAGES I REMEMBER ===
ÔÇö [vivid] Sunset over the ocean
ÔÇö [fading] The cat sleeping on the keyboard
...
=== NEUROCHEMISTRY ===
dopamine: 0.63 Ôû▓ | cortisol: 0.26 ~ | serotonin: 0.56 ~
...
Mimir(
    ...
    llm_fn=None,           # callable(prompt: str) ÔåÆ str for LLM features
)
```
...
| `get_visual(memory)` ÔåÆ dict | Retrieve image bytes with fading applied per vividness tier |
| `forget_visual(memory)` ÔåÆ bool | Remove image attachment, keep text description |
| `recall(context, limit, mood)` ÔåÆ list | Hybrid BM25 + semantic retrieval with 5-signal re-rank |
| `recall_unified(context, limit)` ÔåÆ dict | Cross-type retrieval: reflections, impressions, facts, lessons in one call |
| `resonate(context, limit)` ÔåÆ list | `recall()` + retrieval-induced forgetting + involuntary recall |
| `recall_period(start, end, limit)` ÔåÆ list | Timeline navigation by date range |
| `get_active_self(context)` ÔåÆ list | Top-K self-memories weighted by mood and context |
| `get_context_block(current_entity, conversation_context)` ÔåÆ str | Full memory context for LLM prompt injection |
| `update_mood(emotions)` | EMA-blend mood toward emotion labels |
| `bump_session()` ÔåÆ int | Increment session counter, return new count |
| `save()` | Persist all data to disk |
| `stats()` ÔåÆ dict | Summary of memory system state |
...
| `start_task(description, priority, project)` ÔåÆ TaskRecord | Create task with Zeigarnik anchor |
| `complete_task(task_id, outcome)` ÔåÆ bool | Mark task completed, release Zeigarnik tension |
| `fail_task(task_id, reason)` ÔåÆ bool | Mark task failed, create lesson |
| `get_active_tasks()` ÔåÆ list | Currently active tasks |
| `log_action(task_id, action, result, error, fix)` ÔåÆ ActionRecord | Log per-task action |
| `record_solution(problem, solution, importance)` ÔåÆ SolutionPattern | Store reusable problemÔåÆsolution |
| `find_solutions(problem, top_k)` ÔåÆ list | BM25-matched solutions with reuse boost |
| `track_artifact(name, artifact_type, description, importance)` ÔåÆ ArtifactRecord | Track project artifact |
| `update_artifact(name, **updates)` ÔåÆ bool | Update artifact fields |
| `get_project_overview()` ÔåÆ dict | Full project state snapshot |

#### LLM Integration (optional)

| Method | Description |
|--------|-------------|
| `decompose_query(query)` ÔåÆ list[str] | Break vague query into 2-4 focused sub-queries |
| `edit_memories(instruction)` ÔåÆ dict | LLM-driven PROMOTE/DEMOTE/FORGET/UPDATE |
| `reflect()` ÔåÆ str | Periodic self-analysis of memory patterns & emotional trends |

#### Neuroscience & Graph

| Method | Description |
|--------|-------------|
| `huginn()` ÔåÆ list[Memory] | Pattern detection: entity arcs, recurring themes, open threads |
| `muninn()` ÔåÆ dict | Consolidation: merge duplicates, prune dead, strengthen co-activated |
| `volva_dream(n_samples)` ÔåÆ list[Memory] | Dream synthesis from random memory pairs |
| `sleep_reset(hours)` | Full between-session cycle: chemistry reset + Muninn + Huginn + V├Âlva + Yggdrasil rebuild |
| `detect_drift(include_reframed)` ÔåÆ list | Find memories with significant emotional drift |
| `drift_analysis()` ÔåÆ dict | Enhanced drift: velocity vectors, cognitive bias alerts |
| `decay_priming()` | Decay the spreading-activation buffer by one tick |
| `yggdrasil_roots()` ÔåÆ list | Anchor, flashbulb, and high-importance identity memories |
| `yggdrasil_branches(memory)` ÔåÆ list | Direct neighbours in the memory graph |
| `yggdrasil_traverse(memory, depth)` ÔåÆ list | BFS traversal within N hops |
| `yggdrasil_path(a, b)` ÔåÆ list | Shortest path between two memories |
| `relive(memory)` ÔåÆ dict | Mental time travel ÔÇö re-experience with mood restoration + Yggdrasil activation |
| `enrich_yggdrasil(batch_size)` ÔåÆ int | Batch LLM enrichment of memories without inferred edges |

#### Visualization

| Method | Description |
|--------|-------------|
| `memory_timeline()` ÔåÆ list[dict] | Chronological memory data for plotting |
| `emotion_distribution()` ÔåÆ dict | Memories counted by emotion |
| `importance_histogram()` ÔåÆ dict | Distribution across importance levels 1-10 |
| `arc_distribution()` ÔåÆ dict | Memories by narrative arc position |
| `drift_report()` ÔåÆ list[dict] | Emotionally drifted memories with magnitude |
| `neurochemistry_snapshot()` ÔåÆ dict | Current neurotransmitter state |
| `yggdrasil_graph()` ÔåÆ dict | Adjacency list export for graph visualization |
| `viz_summary()` ÔåÆ dict | All-in-one visualization payload |
...
| `get_active_lessons()` ÔåÆ list | Lessons ranked by vividness (Zeigarnik-boosted) |
| `add_fact(entity, attribute, value)` | Store volatile fact (12h decay) |
| `get_facts(entity)` ÔåÆ list | Return vivid facts, optionally filtered |
...
| `cherish(memory)` | Mark as sentimental favourite (1.1├ù recall boost) |
| `uncherish(memory)` | Remove cherished status |
| `reflect_on_cherished()` ÔåÆ list | Revisit cherished memories |
| `reframe(memory, new_emotion, reason)` ÔåÆ bool | Deliberate emotional reframe (records original, marks intentional) |
...
| `get_due_reminders()` ÔåÆ list | Return reminders that have fired |
...
|---------|-----------|---------|
| Python ÔëÑ 3.10 | Yes | Core language |
...
All optional dependencies use graceful fallback ÔÇö M├¡mir works standalone.
...
- **Content-addressable storage**: Visual images indexed by SHA-256 hash ÔÇö
...
- **Inverted indexes**: Word index for BM25, date index for temporal queries ÔÇö
...
[PolyForm Noncommercial 1.0.0](https://polyformproject.org/licenses/noncommercial/1.0.0/) ÔÇö free for personal and research use. Commercial use requires a separate license.
...
| **M├¡mir** | `pip install vividmimir` | PolyForm-NC |
